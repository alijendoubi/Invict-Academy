                                    ...
                                    <div key={activity.id} className="flex items-center justify-between py-3 border-b border-white/5 last:border-0">
                                        ...
                                        <div className="text-right">
                                            <p className="text-xs text-gray-500 mt-1">
                                                {activity.timestamp ? `${new Date(activity.timestamp).toLocaleDateString([], { month: 'short', day: 'numeric' })}, ${new Date(activity.timestamp).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}` : "—"}
                                            </p>
                                        </div>
                                    </div>
                                ))}
